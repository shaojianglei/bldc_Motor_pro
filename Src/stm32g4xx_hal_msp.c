...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC5     ------> ADC2_IN11
    */
    GPIO_InitStruct.Pin = M1_CURR_AMPL_U_Pin|M1_CURR_AMPL_V_Pin|M1_POTENTIOMETER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  else if(hadc->Instance==ADC2)
  {
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(GPIOC, M1_CURR_AMPL_U_Pin|M1_CURR_AMPL_V_Pin|M1_POTENTIOMETER_Pin);
