...
#define M1_CHARGE_BOOT_CAP_DUTY_CYCLES ((uint32_t)0.500\
...
/* USER CODE BEGIN START_STOP_BTN */
  ...
  {
    /* Ramp parameters sh   ould be tuned for the actual motor */
    (void)MC_StartMotor1();
  }
  else
  {
    (void)MC_StopMotor1();
    /* Clear PID controllers integral terms after stopping the motor */
    // PID_HandleInit(&PIDSpeedHandle_M1);
...
//    
//    /* Clear STO_PLL observer state */
//    STO_PLL_Clear(&STO_PLL_M1);
//    
//    /* Clear speed and torque controller state */
//    STC_Clear(pSTC[M1]);
//    
//    /* Reinitialize ramp manager */
